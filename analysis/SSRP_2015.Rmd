...
```{r, results = 'hide', echo=FALSE, message = FALSE, warning = FALSE}
for (i in factor(m1.24$strain)){

strain <- m1.24$strain[[1]]
duration <- data.frame$duration...

fig.filepath <- paste(duration, strain, 'ResourcesUsed', sep='_')

png(filename = paste("./figures/24hr-ResourcesUsed", i, ".png", sep=""),
...
bp <- barplot(means,
        ...
        xlab = list(paste("Strain: KBS", m1.24$strain[1], sep=""), cex = 1.5, font = 2),
